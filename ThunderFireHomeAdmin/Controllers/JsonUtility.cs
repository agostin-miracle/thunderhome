...
namespace ThunderFireHomeAdmin.Controllers
{
    ...
    //    private ActionResult WriteJson(object data, JsonRequestBehavior behavior)
    //    {
    ...
    //            // THIS INJECTS THE CUSTOM FORMATTER
    ...
    ///// <summary>
    ///// Implements the serialization and deserialization of
    ///// DateTimeOffset type specified in ISO format.
    ///// </summary>
