...
[RoutePrefix("expandedtype")]
    public class ExpandedTypeController : ApiController
  {
private ExpandedTypeDao WRKOBJ = null;
[NonAction]
private bool Init()
{
  if (WRKOBJ == null)
    WRKOBJ = new ExpandedTypeDao();
  if (WRKOBJ != null)
  {
      if (WRKOBJ.Connected)
          return true;
...
/// </summary>
///<param name="model">ExpandedType</param>
/// <returns>ExecutionResponse</returns>
public IHttpActionResult Insert(ExpandedType model)
{
...
///<param name="model">ExpandedType</param>
/// <returns>ExecutionResponse</returns>
public IHttpActionResult Update(ExpandedType model)
{
HttpStatusCode go = HttpStatusCode.OK;
ExecutionResponse RETURN_VALUE = new ExecutionResponse();
if(Init())
...
return Content(go, RETURN_VALUE);
    ...
    /// <returns>List of ExpandedType</returns>
[HttpGet]
