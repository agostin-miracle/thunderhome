...
[RoutePrefix("productmanager")]
    public class ProductManagerController : ApiController
  {
private ProductManagerDao WRKOBJ = null;
[NonAction]
private bool Init()
{
  if (WRKOBJ == null)
    WRKOBJ = new ProductManagerDao();
  if (WRKOBJ != null)
  {
      if (WRKOBJ.Connected)
          return true;
...
public IHttpActionResult Insert(ProductManager model)
{
...
///<param name="model">ProductManager</param>
/// <returns>ExecutionResponse</returns>
public IHttpActionResult Update(ProductManager model)
{
HttpStatusCode go = HttpStatusCode.OK;
ExecutionResponse RETURN_VALUE = new ExecutionResponse();
if(Init())
