...
namespace ThunderFire
{
    ...
    /// <summary>
    /// ISO8583 é um padrão internacional para intercâmbio de mensagens originadas em cartões de transações financeiras.É o padrão da Organização Internacional de Padronização para sistemas que trocam transações eletrônicas iniciadas por portadores de cartão usando cartões de pagamento.
    /// </summary>
    public class ISO8583
    {
        ...
        /// <summary>
        /// EFetua o Parde de uma string
        /// </summary>
        /// <param name="ISOmsg">string</param>
