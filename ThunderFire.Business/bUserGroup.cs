...
ExecutionResponse respond = new ExecutionResponse();
            ...
            this.ProcessCode= 10;
            this.HasError =false;
                            UserGroup ModelAud = Select(model.USUGRP,model.CODUSU,model.SYSGRP);
...
_errormessage="";
    ...
    UserGroup RETURN_VALUE=null;
                    ...
                    try
                    {
            RETURN_VALUE  = _conn.Query<UserGroup>(sql:"PRUSUGRPSEL", param:new {USUGRP=pUSUGRP
