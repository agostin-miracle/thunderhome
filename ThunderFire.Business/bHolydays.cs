...
///<summary>
/// Regra de Negócio para TBCADFER
///</summary>
///<remarks>
...
///Titulo      : SQLDBTools
///Version     : 1.3.0.0
///Data        : 11/04/2022 14:27
///Alias       : holydays
///Descrição   : HolyDays
///</remarks>
    public partial class HolydaysDao : BusinessBase, IHolydays
    {
...
this.KeyTableId =41;
    ...
    /// <returns>int</returns>
        public ExecutionResponse Insert(Holydays model)
        {
            ...
            try
            {
string _changed = Objects.GetPropertiesValue("HolyDays",model,true);
            ...
            p.Add("@DSCFER", model.DSCFER, dbType:DbType.String,  direction: ParameterDirection.Input);
            ...
            p.Add("@UPDUSU", model.UPDUSU, dbType:DbType.Int32,  direction: ParameterDirection.Input);
                _conn.Execute("PRCADFERINS", p,commandType: CommandType.StoredProcedure);
...
_errormessage="";
    ...
    /// <returns>ExecutionResponse</returns>
        public ExecutionResponse Update(Holydays model)
        {
ExecutionResponse respond = new ExecutionResponse();
            int RETURN_VALUE = 0;
            int _AUDNUM = 0;
            this.ProcessCode= 10;
            this.HasError =false;
                            Holydays ModelAud = Select(model.NIDHOL);
string _original = Objects.GetPropertiesValue(ModelAud);
            ...
            var p = new DynamicParameters();
            p.Add("@RETURN_VALUE", 0, dbType:DbType.Int32,  direction: ParameterDirection.Output);
            p.Add("@NIDHOL", model.NIDHOL, dbType:DbType.Int32,  direction: ParameterDirection.Input);
            p.Add("@CODUFE", model.CODUFE, dbType:DbType.String,  direction: ParameterDirection.Input);
            p.Add("@DATMOV", model.DATMOV, dbType:DbType.DateTime,  direction: ParameterDirection.Input);
            p.Add("@DSCFER", model.DSCFER, dbType:DbType.String,  direction: ParameterDirection.Input);
            p.Add("@STAREC", model.STAREC, dbType:DbType.Byte,  direction: ParameterDirection.Input);
            ...
            p.Add("@UPDUSU", model.UPDUSU, dbType:DbType.Int32,  direction: ParameterDirection.Input);
                _conn.Execute("PRCADFERUPD", p,commandType: CommandType.StoredProcedure);
                RETURN_VALUE = (int)p.Get<Int32>("@RETURN_VALUE");
                respond.ReturnValue= RETURN_VALUE;
string _errormessage="";
                if(RETURN_VALUE>0)
          ...
          respond.Logged=_AUDNUM>0;
                    respond.MessageToUser ="FERIADO ALTERADO COM SUCESSO";
_errormessage="";
                }
                if(RETURN_VALUE==-1)
                {
...
_errormessage="";
    ...
    public Holydays Select(System.Int32 pNIDHOL)
        {
        this.Found=false;
            this.ProcessCode= 100;
    Holydays RETURN_VALUE=null;
                    using (IDbConnection _conn = ConnectionFactory.GetConnection())
                    {
                    try
                    {
string _sql = @"SELECT * FROM TBCADFER (NOLOCK) A WHERE (A.NIDHOL=@NIDHOL)";
 RETURN_VALUE = _conn.Query<Holydays>(sql:_sql, param:new {NIDHOL=pNIDHOL
