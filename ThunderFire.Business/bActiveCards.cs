    ...
    public partial class ActiveCardsDao : BusinessBase, IActiveCards
    {
        ...
        public ActiveCards Select(System.Int32 pCODCRT)
        {
            ...
            using (IDbConnection _conn = ConnectionFactory.GetConnection())
            {
                try
                {
                    RETURN_VALUE = _conn.Query<ActiveCards>(sql: "PRREGCRTSEL", param: new
                    {
                        CODCRT = pCODCRT
        ...
        public ActiveCards Select(System.String pNUMCRT)
        {
            ...
            using (IDbConnection _conn = ConnectionFactory.GetConnection())
            {
                try
                {
                    RETURN_VALUE = _conn.Query<ActiveCards>(sql: "PRREGCRTSELCRT", param: new
                    {
                        NUMCRT = pNUMCRT
                    }, commandType: CommandType.StoredProcedure, commandTimeout: 120).FirstOrDefault();
                    this.Found = true;
        ...
        public ExecutionResponse ChangeOnlineShop(System.Int32 pCODCRT, System.Int32 pUPDUSU, System.Byte pAPLCON)
        {
            ...
            using (IDbConnection _conn = ConnectionFactory.GetConnection())
            {
                try
                {
                    ...
                    {
                        respond.Logged = true;
                        respond.MessageToUser = "PERMISSÃO DE CONTA ON LINE ALTERADA COM SUCESSO";
                        _errormessage = "";
                    }
                    if (RETURN_VALUE == -1)
                    {
        ...
        public ExecutionResponse ChangeWithdraw(System.Int32 pCODCRT, System.Int32 pUPDUSU, System.Byte pAPLSAQ)
        {
            ...
            using (IDbConnection _conn = ConnectionFactory.GetConnection())
            {
                try
                {
                    ...
                    RETURN_VALUE = _conn.ExecuteScalar<Int32>(sql: "PRREGCRTCHGSAQPAR", param: p, commandType: CommandType.StoredProcedure, commandTimeout: 120);
                    respond.ReturnValue = RETURN_VALUE;
                    string _errormessage = "";
                    if (RETURN_VALUE == 1)
                    {
        ...
        public List<QueryActiveCards> List(System.Int32? pUSUPRO = null, System.Int16? pSTACRT = null, string pNUMCRT = "", string pNOMPRT = null)
        {
            this.ProcessCode = 0;
            using (IDbConnection _conn = ConnectionFactory.GetConnection())
            {
