...
_errormessage="";
    ...
    LoginUser RETURN_VALUE=null;
                    ...
                    try
                    {
            RETURN_VALUE  = _conn.Query<LoginUser>(sql:"PRLGNUSUSEL", param:new {LGNNUM=pLGNNUM
    ...
    LoginUser RETURN_VALUE=null;
                    ...
                    try
                    {
            RETURN_VALUE  = _conn.Query<LoginUser>(sql:"PRLGNUSUGET", param:new {CODUSU=pCODUSU
},  commandType: CommandType.StoredProcedure, commandTimeout: 120).FirstOrDefault();
                    this.Found = true;
                    }
                    catch (Exception Error)
    ...
    {
            this.ProcessCode= 0;
return IGetAccessControl(pLGNNUM);
    }
